...
class _ContainerChangerState extends State<ContainerChanger> {
  List<PizzaData> pizzalar = [
    PizzaData(
      ...
      image: AssetImage('assets/images/pizzas/margarita_pizza.png'),
    ...
    PizzaData(
      ...
      image: AssetImage('assets/images/pizzas/havaii_pizza.png'),
      title: 'HAVAİİ PİZZA',
      text:
      ...
      image: AssetImage('assets/images/pizzas/pepperoni_pizza.png'),
