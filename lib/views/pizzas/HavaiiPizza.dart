...
if (MediaQuery.of(context).size.shortestSide < 600) {
  ...
  textFontSize = 35.0;
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('HAVAİİ PİZZA TARİFİ', style: GoogleFonts.caveat( fontSize: appBarTitleFontSize, fontWeight: FontWeight.bold),),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 15),
              _buildStepText('5. Sos için, domates sosu, barbekü sos ve rendelenmiş mozzarella peynirini karıştırın.',textFontSize),
              SizedBox(height: 15),
              ...
              SizedBox(height: 15),
              _buildStepText("9. Dilimlenmiş jambon veya hindi jambonunu, döner parçalarını (varsa), dilimlenmiş ananası ve isteğe bağlı diğer malzemeleri serpiştirin.",textFontSize),
              SizedBox(height: 15),
              _buildStepText('10. Pizza hamurunu önceden ısıtılmış fırına verin ve yaklaşık 15-20 dakika kadar veya hamurun kenarları altın kahverengi olana kadar pişirin.',textFontSize),
              SizedBox(height: 15),
              _buildStepText('11. Pizza fırından çıktıktan sonra birkaç dakika dinlendirin, dilimleyin ve sıcak servis yapın.',textFontSize),
              SizedBox(height: 50),
