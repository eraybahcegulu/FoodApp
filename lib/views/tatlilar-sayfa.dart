...
import 'package:foodapp/views/tarife-bak/tatlilar/kibris.dart';
import 'package:foodapp/views/tarife-bak/tatlilar/sutlac.dart';
import 'package:foodapp/views/tarife-bak/tatlilar/trilece.dart';
import 'package:foodapp/views/tarife-bak/tatlilar/mozaik-pasta.dart';
import 'malzemeler/tatlilar.dart';
...
class _ContainerChangerState extends State<ContainerChanger> {
  List<TatliData> tatlilar = Tatlilar.getTatlilar();
  ...
  void navigateToRecipePage() {
    ...
    if (recipePages.containsKey(currentIndex)) {
      Navigator.push(
        context,
