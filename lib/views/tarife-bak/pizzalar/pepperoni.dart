        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 15),
              _buildStepText(
                  '5. Sos için, domates sosunu sarımsak, kekik, fesleğen, tuz ve karabiberle karıştırın.',
                  textFontSize),
              SizedBox(height: 15),
              _buildStepText(
              ...
              SizedBox(height: 15),
              _buildStepText(
                  "9. Üzerine mozzarella peyniri serpin.", textFontSize),
              SizedBox(height: 15),
              _buildStepText(
                  "10. Dilimlenmiş pepperoni sosisi ve isteğe bağlı diğer malzemeleri serpiştirin.",
                  textFontSize),
              SizedBox(height: 15),
              _buildStepText(
                  "11. Pizza hamurunu önceden ısıtılmış fırına verin ve yaklaşık 15-20 dakika kadar veya hamurun kenarları altın kahverengi olana kadar pişirin.",
                  textFontSize),
              SizedBox(height: 15),
              _buildStepText(
                  "12. Pizza fırından çıktıktan sonra birkaç dakika dinlendirin, dilimleyin ve sıcak servis yapın.",
                  textFontSize),
              Divider(
                color: Colors.black,
                thickness: 1,
