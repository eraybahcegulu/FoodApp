        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 15),
              _buildStepText(
                  '5. Sos için, domates sosunu sarımsak, kekik, tuz ve karabiberle karıştırın.',
                  textFontSize),
              SizedBox(height: 15),
              _buildStepText(
              ...
              SizedBox(height: 15),
              _buildStepText(
                  "9. Üzerine rendelenmiş mozzarella peyniri serpin.",
                  textFontSize),
              SizedBox(height: 15),
              _buildStepText(
                  "10. Fırına verin ve yaklaşık 15-20 dakika kadar veya hamurun kenarları altın kahverengi olana kadar pişirin.",
                  textFontSize),
              SizedBox(height: 15),
              _buildStepText(
                  "11. Fırından çıkardıktan sonra taze fesleğen yaprakları ile süsleyin.",
                  textFontSize),
              SizedBox(height: 15),
              _buildStepText(
                  "12. Pizza birkaç dakika dinlendikten sonra dilimleyin ve sıcak servis yapın.",
                  textFontSize),
              Divider(
                color: Colors.black,
                thickness: 1,
              ...
              SizedBox(height: 15),
              _buildStepText(
                  '3) Margarita pizza, sade ve lezzetli bir pizza çeşididir ve genellikle taze malzemelerle hazırlanır. Fesleğen yaprakları pizzanın ana lezzeti olabilir, bu yüzden mümkünse taze fesleğen kullanmanız önerilir.',
                  textFontSize),
            ],
          ),
        ),
